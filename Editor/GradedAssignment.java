...
public class GradedAssignment extends JFrame implements FocusListener {

    private JMenuItem _new = new JMenuItem("New",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\new.png"));
    private JMenuItem _open = new JMenuItem("Open",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\open.png"));
    private JMenuItem _save = new JMenuItem("Save",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\save.png"));
    private JMenuItem _saveas = new JMenuItem("Save as...",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\saveas.png"));
    private JMenuItem _exit = new JMenuItem("Exit",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\exit.png"));
    private JMenuItem _undo = new JMenuItem("Undo",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\undo.png"));
    private JMenuItem _redo = new JMenuItem("Redo",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\redo.png"));
    private JMenuItem _cut = new JMenuItem("Cut",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\cut.png"));
    private JMenuItem _copy = new JMenuItem("Copy",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\copy.png"));
    private JMenuItem _paste = new JMenuItem("Paste",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\paste.png"));
    private JMenuItem _find = new JMenuItem("Find",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\find.png"));
    private JMenuItem _find_and_replace = new JMenuItem("Find and Replace",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\find_and_replace.png"));
    private JMenuItem _count = new JMenuItem("Word Count",new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\wordcnt.png"));
    ...
    String[] fonts = {"Arial", "Berlin Sans FB", "Calibri", "Cambria","Cooper Black", "Courier New", "Comic Sans MS", "Dialog", "Georgia", "Helevetica", "Impact", "Lucida Sans", "Maiandra GD","Malgun Gothic","SignPainter",  "Times New Roman", "Verdana", };
    ...
    GradedAssignment() {
        ...
        _font.setIcon(new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\find.png"));
        _size.setIcon(new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\size.png"));
        _case.setIcon(new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\case.png"));
        ...
        ImageIcon bold = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\bold.png", "Makes Text Bold");
        JToggleButton jbtBold = new JToggleButton(bold);
        ImageIcon italics = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\italics.png", "Makes Text Italic");
        JToggleButton jbtItalics = new JToggleButton(italics);
        ImageIcon underline = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\underline.png", "Makes Text underlined");
        JToggleButton jbtUnderline = new JToggleButton(underline);
        ImageIcon strikethrough = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\strikethrough.png", "Strikes through text");
        JToggleButton jbtStrikethrough = new JToggleButton(strikethrough);
        ImageIcon leftalign = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\leftalign.png", "Left aligns text");
        JToggleButton jbtLeftalign = new JToggleButton(leftalign);
        ImageIcon rightalign = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\rightalign.png", "Right aligns text");
        JToggleButton jbtRightalign = new JToggleButton(rightalign);
        ImageIcon centeralign = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\centeralign.png", "Centre aligns text");
        JToggleButton jbtCenteralign = new JToggleButton(centeralign);
        ImageIcon justify = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\justify.png", "Justifies text");
        JToggleButton jbtJustify = new JToggleButton(justify);
        ImageIcon increase = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\increase.png", "Increases font size");
        JButton jbtIncrease = new JButton(increase);
        ImageIcon decrease = new ImageIcon("C:\\Users\\Akshat\\Pictures\\Java Icons\\decrease.png", "Decreases font size");
    ...
    public static void main(String[] args) {
        JFrame frame = new GradedAssignment();
    ...
    {
        final int X=5;
        private boolean rect=false, oval=false, line=false, triangle=false, pentagon=false;
        int r_x1,r_y1,r_w,r_h;
        int l_x1,l_x2,l_y1,l_y2;
        int t_x1, t_y1, t_x2, t_y2, t_x3, t_y3;
        int p_x1, p_x2, p_x3, p_x4, p_x5, p_y1, p_y2, p_y3, p_y4, p_y5;
        ...
        public void dragmouse(MouseEvent e)
        {
            if(rect==true||oval==true) {
                ...
                if (e.getX() <= r_x1 + r_w + X && e.getX() >= r_x1 + r_w - X && e.getY() <= r_y1 + r_h + X && e.getY() >= r_y1 + r_h - X) {
                    r_w = e.getX() - r_x1;
                    r_h = e.getY() - r_y1;
                    if (r_w < 4 * X)
                        r_w = 4 * X;
                ...
                if (e.getX() <= r_x1 + r_w + X && e.getX() >= r_x1 + r_w - X && e.getY() <= r_y1 + X && e.getY() >= r_y1 - X) {
                    final int r_y2 = r_y1 + r_h;
                    r_w = e.getX() - r_x1;
                    r_y1 = e.getY();
                    r_h = r_y2 - r_y1;
                ...
                if (e.getX() <= r_x1 + X && e.getX() >= r_x1 - X && e.getY() <= r_y1 + r_h + X && e.getY() >= r_y1 + r_h - X) {
                    final int r_x2 = r_x1 + r_w;
                    r_h = e.getY() - r_y1;
                    r_x1 = e.getX();
                    r_w = r_x2 - r_x1;
            ...
            else if(line==true)
            {
                ...
                if(e.getX()<=(l_x1+l_x2)/2+X&&e.getX()>=(l_x1+l_x2)/2-X&&e.getY()<=(l_y1+l_y2)/2+X&&e.getY()>=(l_y1+l_y2)/2-X)
                {
            ...
            else if(triangle==true)
            {
                ...
                if(e.getX()<=(t_x1+t_x2+t_x3)/3+X&&e.getX()>=(t_x1+t_x2+t_x3)/3-X&&e.getY()<=(t_y1+t_y2+t_y3)/3+X&&e.getY()>=(t_y1+t_y2+t_y3)/3-X)
                {
    ...
    private void cutEditActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            Logger.getLogger(GradedAssignment.class.getName()).log(Level.SEVERE, null, ex);
        }
